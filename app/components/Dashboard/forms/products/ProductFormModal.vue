...
<template>
  <UModal v-model:open="open" title="New Product" description="Create a new product in the database">
    ...
    <template #body>
      ...
      >
        ...
        <UFormField label="Price" name="price">
          <UInput v-model.number="state.price" type="number" min="0" step="0.01" class="w-full" />
        </UFormField>
